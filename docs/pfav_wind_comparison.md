# Посекторное сопоставление $p_{fav\_wind}$: станция vs. ERA5

_Дата анализа: 2026-05-21_
...
- **Источник 2 (ERA5):** ячейка (59.75°N, 30.25°E),
...
| Среднее $p_{fav\_wind}$ (ERA5) | 0.2447 |
...
у ERA5 составляет 0.245, у станции — 0.202.
RMSE посекторных оценок равен 5.54 процентных пунктов,
секторов с расхождением менее 5 п.п. — 12 из 18.

**Систематическое смещение.** ERA5 в среднем переоценивает долю благоприятных часов
на 4.23 п.п. Максимум переоценки наблюдается в
секторе $\theta = 20°$ и составляет
11.0 п.п. Это направление соответствует
прохождению потока над окраинно-приморской зоной
